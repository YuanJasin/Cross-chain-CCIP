...
// OwnerIsCreator: 用于控制合约的oner权限
// CCIP: 继承这个合约用于接收chainklink用于发送信息的函数
contract NFTPoolLockAndMint is CCIPReceiver, OwnerIsCreator {
    ...
    function burnAndSendNFT(uint256 tokenId,address newOwner,uint64 chainSelector,address receiver) public  returns (bytes32) {
        ...
        // burn the wnft before send to cccip
        wnft.burn(tokenId);
        ...
        override
    {
        ...
        wnft.mintToenWithSpecificTokenId(newOwner,tokenId);
